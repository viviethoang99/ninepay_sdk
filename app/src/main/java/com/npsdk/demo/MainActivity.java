...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (url.isEmpty())
            url = "https://dev-payment.9pay.mobi/portal?baseEncode=&signature=tTHboWgriSTpyFi3%2FBq2XlewDwM65sNPlXpos69faCw%3D";
        switch (v.getId()) {
