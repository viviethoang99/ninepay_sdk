...
//		startActivity(intent);
    ...
    public void onClick(View v) {
        ...
        if (url.isEmpty())
            url = "https://dev-payment.9pay.mobi/portal?baseEncode=&signature=PtBAQnQ1Vzcqmg4cSK4q0oDlQeWAkIQpgB5F33pn2uE%3D";
        switch (v.getId()) {
