...
public class Actions {
    ...
    public static final String BILLING_TOPUP = "BILLING_TOPUP";
    public static final String BILLING_PHONE_CARD = "BILLING_PHONE_CARD";
    public static final String BILLING_DATA_CARD = "BILLING_DATA_CARD";
    public static final String BILLING_GAME = "BILLING_GAME";
    public static final String BILLING_SERVICE_CARD = "BILLING_SERVICE_CARD";
